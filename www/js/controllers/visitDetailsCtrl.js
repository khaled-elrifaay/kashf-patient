angular.module('app.controllers')
        .controller('visitDetailsCtrl', function ($scope, $stateParams, $ionicPlatform,$state) {
            $scope.$on("$ionicView.enter", function (event, data) {
                ...
                var response = JSON.parse($stateParams.visit_details);
                ...
                $scope.diagnoses = response.diagnoses;
