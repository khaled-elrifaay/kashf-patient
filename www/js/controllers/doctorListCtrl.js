angular.module('app.controllers')
        .controller('doctorListCtrl', function ($scope, $state, $stateParams, DoctorsService, $ionicPlatform,configService,$ionicLoading) {
            configService.setEmptyReqLock(true);
            var myLocation = new google.maps.LatLng(window.localStorage.getItem('Lat'),  window.localStorage.getItem('Long'));
            ...
            console.log("url",$scope.base_url );
