angular.module('app.controllers')
        .controller('specializationCallCtrl', function ($scope, specService, WebService, $ionicPlatform, $state, profileService, gradeService) {
            ...
            $scope.search = function () {
                ...
                if ($scope.spec != null && $scope.pid != null && $scope.gender != null && $scope.grade != null) {
                    $state.go("doctorCallList", {speId: $scope.spec, patientId: $scope.pid, gender: $scope.gender, grade: $scope.gradeval, major: $scope.spec_name_major, minor: $scope.spec_name_minor, });
                } else {
